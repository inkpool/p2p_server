...
public class Invest implements Parcelable {
	...
	public Invest(Long investId, Long userId, String investDate,
			...
			String gmtCreate, String gmtModify, String comment) {
		super();
		this.investId = investId;
		this.userId = userId;
		this.investDate = investDate;
	...
	public Invest(Cursor cursor) {
		...
		this.gmtModify = cursor.getString(cursor.getColumnIndex("gmt_modify"));
	...
	public String toString() {
		return "Invest [investId=" + investId + ", userId=" + userId
				...
				+ gmtCreate + ", gmtModify=" + gmtModify + ", comment="
				+ comment + "]";
	}
