...
public class TransactionListAdapter extends BaseAdapter {
	...
	public TransactionListAdapter(InvestListActivity investView,
			ArrayList<Object> trans) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (item.getClass() == Invest.class) {
			...
			int days=Function.nDaysBetweenTwoDate(data.getInvestDate(), data.getRepaymentEndingDate());
			String interest = String.format("+%.2f", data.getInterestRateMin()
					* data.getAmount() / 100 / 365 * days);
